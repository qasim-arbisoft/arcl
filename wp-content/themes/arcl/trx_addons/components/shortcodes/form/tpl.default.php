	...
	<div class="sc_form_details <?php echo esc_attr(trx_addons_get_columns_wrap_class()); ?>"><?php
		...
		?><div class="<?php echo esc_attr(trx_addons_get_column_class(1, 2)); ?>"><?php
			do_action('trx_addons_action_field_custom', array_merge($args, array('field_name' => 'first_name',
                ...
                'field_req' => true,
                'field_icon' => '',
                'field_title' => esc_html__('First Name', 'lighthouseschool'),
                'field_placeholder' => esc_html__('First Name', 'lighthouseschool'))));
		?></div><div class="<?php echo esc_attr(trx_addons_get_column_class(1, 2)); ?>"><?php
            do_action('trx_addons_action_field_custom', array_merge($args, array('field_name' => 'last_name',
                ...
                'field_placeholder' => esc_html__('Last Name', 'lighthouseschool'))));
            ?></div><div class="<?php echo esc_attr(trx_addons_get_column_class(1, 2)); ?>"><?php
			do_action('trx_addons_action_field_email',array_merge($args,array('field_placeholder' => esc_html__('Email', 'lighthouseschool'))));
		?></div><div class="<?php echo esc_attr(trx_addons_get_column_class(1, 2)); ?>"><?php
            do_action('trx_addons_action_field_custom', array_merge($args, array('field_name' => 'subject',
                ...
                'field_req' => false,
                'field_icon' => '',
                'field_title' => esc_html__('Subject', 'lighthouseschool'),
                'field_placeholder' => esc_html__('Subject', 'lighthouseschool'))));
            ?></div><?php
	?></div><?php
	do_action('trx_addons_action_field_message', array_merge($args,array('field_placeholder' => esc_html__('Message', 'lighthouseschool'))));
