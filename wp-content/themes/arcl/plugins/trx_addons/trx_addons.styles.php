...
if (!function_exists('lighthouseschool_trx_addons_get_css')) {
	add_filter('lighthouseschool_filter_get_css', 'lighthouseschool_trx_addons_get_css', 10, 4);
	function lighthouseschool_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.sc_services_numbered .sc_services_item_title a:hover {
	color: {$colors['text_link']};
}
