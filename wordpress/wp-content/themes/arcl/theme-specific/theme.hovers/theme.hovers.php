...
if ( !function_exists( 'lighthouseschool_hovers_frontend_scripts' ) ) {
	//Handler of the add_action( 'wp_enqueue_scripts', 'lighthouseschool_hovers_frontend_scripts', 1010 );
...
if (!function_exists('lighthouseschool_hovers_merge_scripts')) {
	//Handler of the add_filter( 'lighthouseschool_filter_merge_scripts', 'lighthouseschool_hovers_merge_scripts' );
...
if (!function_exists('lighthouseschool_hovers_merge_styles')) {
	//Handler of the add_filter( 'lighthouseschool_filter_merge_styles', 'lighthouseschool_hovers_merge_styles' );
...
if (!function_exists('lighthouseschool_hovers_localize_script')) {
	//Handler of the add_filter( 'lighthouseschool_filter_localize_script','lighthouseschool_hovers_localize_script' );
...
if ( !function_exists('lighthouseschool_hovers_add_icons') ) {
	function lighthouseschool_hovers_add_icons($hover, $args=array()) {
		...
		// Hover style 'Icon'
			...
			?><div class="icons"><a href="<?php esc_url(the_permalink()); ?>" aria-hidden="true" class="icon-img_preview"></a></div><?php
...
if ( !function_exists( 'lighthouseschool_hovers_get_css' ) ) {
	//Handler of the add_filter( 'lighthouseschool_filter_get_css', 'lighthouseschool_hovers_get_css', 10, 4 );
